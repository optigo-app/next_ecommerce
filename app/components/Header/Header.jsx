        ...
        <>
          <div className="smr_smlingSearchoverlay">
            <div className="smr_smlingTopSerachOver">
              <IoSearchOutline onClick={() => clickSearch()} style={{ height: "15px", width: "15px", marginRight: "10px" }} />
        ...
        <div className="smiling_Top_header_sub">
          <div className="smiling_Top_header_div1">
            ...
            <ul className="nav_ul_shop">
              ...
              {htmlContent?.rd && htmlContent?.rd.length > 0 && htmlContent?.rd[0]?.ExtraMenu == 1 && (
                <>
        ...
        <div className="smr_left_side_menu_list">
          {menuItems?.map((menuItem) => (
            <div key={menuItem.menuid} className="smr_menu_level_0">
              ...
              >
                <a className="smr_menu_level_0_title" href={`/p/${menuItem?.menuname}/?M=${btoa(`${menuItem?.param0dataname}/${menuItem?.param0name}`)}`}>
                  {menuItem.menuname}
                </a>
              </div>
              <>
                <div className="smr_menu_level_1">
                  {menuItem.param1.map((subMenuItem) => (
                    <div key={subMenuItem.param1dataid}>
                      ...
                      >
                        <a className="smr_menu_level_1_title" href={`/p/${menuItem?.menuname}/${menuItem?.param0dataname}/${subMenuItem.param1dataname}/?M=${btoa(`${menuItem?.param0dataname},${subMenuItem.param1dataname}/${menuItem?.param0name},${subMenuItem.param1name}`)}`}>
                          {subMenuItem?.param1dataname}
                        </a>
                      </div>
                      <>
                        <div className="smr_menu_level_2">
                          {subMenuItem.param2.map((subSubMenuItem) => (
                            ...
                            >
                              <a className="smr_menu_level_2_title" href={`/p/${menuItem?.menuname}/${menuItem?.param0dataname}/${subMenuItem.param1dataname}/${subSubMenuItem.param2dataname}/?M=${btoa(`${menuItem?.param0dataname},${subMenuItem.param1dataname},${subSubMenuItem.param2dataname}/${menuItem?.param0name},${subMenuItem.param1name},${subSubMenuItem.param2name}`)}`}>
                                {" "}
                ...
                {menuItem.param1.map((subMenuItem) => (
                  <div key={subMenuItem.param1dataid}>
                    ...
                    >
                      ...
                      <a
                        href={`/p/${menuItem?.menuname}/${menuItem?.param0dataname}/${subMenuItem.param1dataname}/?M=${btoa(`${menuItem?.param0dataname},${subMenuItem.param1dataname}/${menuItem?.param0name},${subMenuItem.param1name}`)}`}
                        className="smr_menuSubTitle"
                    ...
                    <>
                      ...
                      >
                        {subMenuItem.param2.map((subSubMenuItem) => (
                          ...
                          >
                            <a
                              href={`/p/${menuItem?.menuname}/${menuItem?.param0dataname}/${subMenuItem.param1dataname}/${subSubMenuItem.param2dataname}/?M=${btoa(`${menuItem?.param0dataname},${subMenuItem.param1dataname},${subSubMenuItem.param2dataname}/${menuItem?.param0name},${subMenuItem.param1name},${subSubMenuItem.param2name}`)}`}
                              className="smr_menuSubTitle"
                              // onClick={() =>
                              //   handelMenu(
                              //     {
