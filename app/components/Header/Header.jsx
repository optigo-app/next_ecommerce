              ...
              {IsB2BWebsiteChek == 0 ? (
                ...
                islogin && (
                  <>
                    ...
                    <li className="nav_li_smining_Icone smr_mobileHideIcone" onClick={toggleOverlay} style={{ cursor: "pointer" }}>
                      <SearchRoundedIcon
                        style={{
                          height: "20px",
                          cursor: "pointer",
                    ...
                    {menuItem.param1.map((subMenuItem) => {
                      ...
                      return (
                        <div key={subMenuItem.param1dataid}>
                          ...
                          >
                            <Link className="smr_menu_title_1" href={`/p/${menuItem?.menuname}/${menuItem?.param0dataname}/${subMenuItem.param1dataname}/?M=${btoa(`${menuItem?.param0dataname},${subMenuItem.param1dataname}/${menuItem?.param0name},${subMenuItem.param1name}`)}`}>
                              {subMenuItem?.param1dataname}
                            </Link>
                          </div>
                          <>
